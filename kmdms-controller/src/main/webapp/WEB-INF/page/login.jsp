			...
			<div class="row">
				...
				<div id="kmdms-login" class="col-md-4">
					<form method="post" action="${pageContext.request.contextPath}/student/login.action">
						...
						<div>
							<input id="kmdms-login-name" type="text" name="stuId" value="${studentCustom.stuId}" placeholder="请输入学号" />
							<p id="kmdms-login-name-error">&nbsp;</p>
						</div>
						<div>
							<input id="kmdms-login-pwd" type="password" name="password" value="${studentCustom.password}" placeholder="请输入密码" />
